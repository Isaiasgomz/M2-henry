...
addName.innerText += ' Isaias Gomez'
...
function addToDo() {
  // Tu código acá:
  let inputNode = document.querySelector('#toDoInput')
  if(inputNode.value !== ''){

    let crearElement = new ToDo(inputNode.value)
    toDoItems.push(crearElement)
    inputNode.value = ''
  }
  displayToDos()
